    ...
    <div className="mobile-container overflow-y-auto scrollbar-hide safe-bottom">
      ...
      <div className="px-6 -mt-8 relative">
        ...
        <p className="text-muted-foreground text-sm flex items-center gap-1 mb-4">
          ...
          {profile.online && <span className="ml-2 w-2 h-2 rounded-full inline-block bg-neon" />}
          {profile.online && <span className="text-neon text-xs">Online</span>}
        </p>
        <p className="text-secondary-foreground text-sm mb-6">{profile.bio}</p>
